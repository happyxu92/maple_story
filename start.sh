...
$JAVA_7_HOME/bin/java -DhomePath=./config/ -DscriptsPath=../scripts-master/ -DwzPath=../scripts-master/wz -Xms512m -Xmx2048m -XX:PermSize=256m -XX:MaxPermSize=512m -XX:MaxNewSize=512m -jar ./bin/maple.jar
